...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} - Made By Serialz")
    elif system == 'posix':
        sys.stdout.write(f"\x1b]0;{_str} - Made By Serialz\x07")
    else:
        pass
...
def discserver():
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------\n{w}PROTOTYPE {b}|{w} VERSION NON FINALE {b}|{w} - {b}|{w} - {b}|{w} - {b}|{w} -\n{y}------------------------------------------------------------------------------------------------------------------------\n""")
